...
export function ChefClient() {
    ...
    return (
        <div className="min-h-screen bg-background pb-10 font-sans text-foreground">
            ...
            <div className="p-4 md:p-6">
                <div className="flex items-center justify-between mb-6 md:mb-8 max-w-7xl mx-auto gap-4">
                    ...
                    <div className="flex gap-2">
                        <Button variant="outline" size="sm" onClick={() => playNotification()} className="rounded-full h-9 border-neutral-200 dark:border-neutral-800 gap-2">
